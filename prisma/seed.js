  ...
  const plans = [
    {
      ...
      maxWebhooks: -1,       maxCustomFields: 0,
    ...
    },
    {
      ...
      hasTeams: true,        hasMultiChannel: false,
      hasDealPipeline: false, hasIntentTraining: false,
      hasCustomAiPrompts: false, hasCustomProviders: false,
      hasWhiteLabel: false,  hasApiAccess: false,
    ...
    },
    {
      ...
      maxWebhooks: -1,       maxCustomFields: 10,
      maxTeams: 5,           maxStorageMb: -1,
    ...
    },
    {
      ...
      annualDiscountPct: 20,
      maxUsers: 100,         maxCustomers: 100000,
      creditsPerMonth: 1000,
      maxAiCallsPerMonth: -1, maxLeadUploadsPerMonth: 1000,
